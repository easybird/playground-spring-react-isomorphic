var CommentForm = React.createClass({
    ...
    render: function () {
        return (
            <form ref="form" className="navbar-form navbar-right" method="POST" action="/save" onSubmit={ this.handleSubmit }>
                <div className="form-group">
                    <input type="text" name="author" ref="author" placeholder="Your name" className="form-control" />
                </div>
                <div className="form-group">
                    <input type="text" name="content" ref="content" placeholder="Say something..." className="form-control " />
                </div>
